...
export default function SvgRudderMASSLAB({
  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      <svg xmlns="http://www.w3.org/2000/svg" width="837" height="862" fill="none" viewBox="0 0 837 862" overflow="visible">
              ...
              <g id="bar-component">
                ...
                <path
                  ...
                  style={{
                    strokeDasharray: rudderPathLength,
                    strokeDashoffset:
                      actAngle > 0 ? rudderPathLength : rudderPathLength * (actAngle / maxAngle) - rudderPathLength,
                    transformOrigin: "center",
                    transformBox: "fill-box",
                  }}
                  strokeWidth="80"
